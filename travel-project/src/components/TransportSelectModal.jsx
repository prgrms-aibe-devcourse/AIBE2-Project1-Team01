...
const TransportSelectModal = ({ onConfirm, onClose }) => {
  ...
  return (
    <div className="transport-modal">
      ...
      <p className="modal-subtitle">
        여행 시 이용하는 이동수단을 선택해 주세요.
      </p>

      <div className="transport-options">
        <div
          className={`transport-card ${
            selected === "대중교통" ? "selected" : ""
          }`}
      ...
      <div className="transport-footer">
        <button className="confirm-button" onClick={() => onConfirm(selected)}>
          일정 생성
        </button>
      </div>
    </div>
